...
public class ZipperStep extends AbstractStepDefinition {
    ...
    public StepResult invoke(StepExecutionContext context) {
        ...
        String operationZip = context.getDataValue("OPERATION", String.class);
        context.addLog(String.format("About to perform operation %s on source %s", sourcePath, operationZip));
        if(sourcePath == null || sourcePath == "" || operationZip == null || operationZip == ""){
        ...
        if(operationZip == EnumZip.UNZIP.getValue()){
